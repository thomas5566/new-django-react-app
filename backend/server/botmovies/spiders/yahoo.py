...
from botmovies.items import YahooCloudItem
...
class YahooSpider(CrawlSpider):
    ...
    custom_settings = {
        ...
        "DOWNLOAD_DELAY": 3,
        "ITEM_PIPELINES": {
            "botmovies.pipelines.CustomImagePipeline": 1,
            "botmovies.pipelines.YahooPipeline": 100,
            "botmovies.pipelines.DeleteNullTitlePipeline": 200,
            "botmovies.pipelines.DuplicatesTitlePipeline": 200,
            "botmovies.pipelines.CsvExportPipeline": 300,
        },
